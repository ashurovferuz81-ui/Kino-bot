...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for ch in db["channels"]:
        if ch.startswith("@"):
            ...
            buttons.append([InlineKeyboardButton("📢 Kanalga kirish", url=ch)])  # private link

    # Obuna buldim va VIP tugmasi
    ...
    await update.message.reply_text("📢 Shu kanallarga obuna bo‘ling va 'Obuna buldim' tugmasini bosing", reply_markup=InlineKeyboardMarkup(buttons))
