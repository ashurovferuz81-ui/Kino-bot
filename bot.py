...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not await check_subscription(user_id, context.bot):
        buttons = [[InlineKeyboardButton("📢 Kanalga kirish", url=f"https://t.me/{ch.replace('@','')}")] for ch in db["channels"]]
    ...
    await update.message.reply_text("🎬 Kino kodini yuboring!", reply_markup=InlineKeyboardMarkup([vip_button]))
